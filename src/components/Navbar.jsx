...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 py-6 backdrop-blur-lg border-b border-neutral-700/80 bg-white">
        <div className="container px-4 mx-auto relative text-sm">
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-12 text-black">
                  ...
                  <Button variant="secondary" href="#" className="hidden lg:block">Ceník</Button>
                </div>
